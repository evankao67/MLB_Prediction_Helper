...
SET team_id = 
    CASE
        ...
        WHEN team_name = 'Kansas City Royals' THEN 'KCR'
        WHEN team_name = 'Los Angeles Angels of Anaheim' THEN 'ANA'
        ...
        WHEN team_name = 'San Diego Padres' THEN 'SDP'
        WHEN team_name = 'San Francisco Giants' THEN 'SFG'
        WHEN team_name = 'Seattle Mariners' THEN 'SEA'
        WHEN team_name = 'St. Louis Cardinals' THEN 'STL'
        WHEN team_name = 'Tampa Bay Rays' THEN 'TBD'
